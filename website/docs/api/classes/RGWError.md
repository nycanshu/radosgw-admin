...
- [`RGWNotFoundError`](RGWNotFoundError.md)
- [`RGWValidationError`](RGWValidationError.md)
- [`RGWAuthError`](RGWAuthError.md)
- [`RGWConflictError`](RGWConflictError.md)

## Constructors

### Constructor

> **new RGWError**(`message`, `statusCode?`, `code?`, `uid?`): `RGWError`
